        ...
        >
            ...
            >
                <PayCard>
                    ...
                    <p style={{fontSize: '13px', margin: 0}}>درصورت کسر مبلغی از حساب در مدت حداکثر ۷۲ ساعت مبلع به حساب
                        شما باز خواهد گشت.</p>
                    <p> جهت اطلاعات بیشتر می توانید با شماره تلفن <a
                        href={`tel:${SUPPORT_PHONE_NUMBER}`}>{SUPPORT_PHONE_NUMBER}</a> در ارتباط باشید. </p>
                    <CheckBoxButton
                        onlyBtn={true}
